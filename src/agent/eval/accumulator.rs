...
pub struct ContractSnapshot {
    ...
    /// Material evidence obligations generated by semantic task assessment.
    /// A raw observation count cannot substitute for closing these needs.
...
impl HarnessEvalAccumulator {
    ...
    pub fn record_completion_contract(&mut self, contract: &CompletionContract) {
        ...
        self.contract.evidence_requirements_total = contract.evidence_requirements.len() as u32;
    }
    ...
    pub fn record_completion_progress(&mut self, progress: &CompletionProgress) {
        ...
        self.contract.evidence_requirements_satisfied =
            progress.satisfied_evidence_requirements() as u32;
...
impl From<ContractSnapshot> for crate::events::ContractFulfillmentPayload {
    fn from(value: ContractSnapshot) -> Self {
        Self {
            ...
            evidence_requirements_total: value.evidence_requirements_total,
            evidence_requirements_satisfied: value.evidence_requirements_satisfied,
